...
# Display Python version and library versions
import platform
...
# user_attractions.to_csv('path_to_save.csv')
# plt.figure(figsize=(10, 5))
# plt.plot(user_attractions['movieId'], user_attractions['rating'], 'o-')
# plt.title('Movie Attractions for User 1')
# plt.xlabel('Movie ID')
